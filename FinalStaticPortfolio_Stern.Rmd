...
```{r, fig.width = 14, fig.height= 12, warning= FALSE, results='hide',fig.keep='all', message=FALSE}
...
ne_data <- st_read(here("data/ne_110m_populated_places", "ne_110m_populated_places.shp"))
