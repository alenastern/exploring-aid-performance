...
th <- theme(axis.title = element_text(family = "Montserrat-Italic", color = "#000000", size = 12),
            ...
            panel.grid.minor = element_line (color = "#FFFFFF", size = 0.25),
...
Blue Scale - 6:
#125169 #206b8c #2699D0 (#3a86ac) #5aa1c8 #7fbdde #a9d9ef
Blue Scale - 3
#125169 #2699D0 #a9d9ef

Orange Scale - 6:
#b83d05 #c95714 #F69D30 (#d87124) #e78938 #f3a352 #fabe7a
Orange Scale - 3
#b83d05 #F89E37 #fabe7a

Diverging 6-point scale: c("#125169", "#2699D0", "#a9d9ef","#fabe7a", "#F89E37", "#b83d05")

Text = Montserrat
Title/Subtitle/Axis Labels = Montserrat-Regular
Axis Title = Montserrat-Italic

Title = 18pt, Subtitle = 14pt, Axis labels = 12pt, Axis titles = 12pt, Source: 10pt

Background Color = Light Gray: #e6e6e6
panel.grid.major = White #FFFFFF, size = .5
panel.grid.minor = White #FFFFFF, size = .25
...
ggplot(data_sdg_ghana, aes(x= rank.x, y = rank.y, fill = discrete_performance)) + 
  ...
  scale_fill_manual( values = rev(c("#125169", "#2699D0", "#a9d9ef","#fabe7a", "#F89E37", "#b83d05")), na.value="dark gray") +
